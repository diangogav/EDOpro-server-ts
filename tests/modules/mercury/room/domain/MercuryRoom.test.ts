...
describe("MercuryRoom", () => {
  ...
  it("Should create a single match room, with the last tcg list if lf command is bad", () => {
    ...
    const room1 = MercuryRoom.create(
      id,
      "lfbad#123",
      logger,
      emitter,
    ...
    const room2 = MercuryRoom.create(
      id,
      "lf#123",
      logger,
      emitter,
  ...
  describe("Genesys Format", () => {
    ...
    it("Should be create a room with Genesys format if command constains genesys250 with max deck points 250", () => {
      const room = MercuryRoom.create(
        id,
        "genesys250#123",
        logger,
